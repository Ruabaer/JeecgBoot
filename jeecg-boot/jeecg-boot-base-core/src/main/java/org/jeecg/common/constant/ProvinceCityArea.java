        ...
        if (StringUtils.isNotBlank(text)) {
            ...
            if (areaList != null && areaList.size() > 0) {
                for (int i = areaList.size() - 1; i >= 0; i--) {
                    // update-begin-author:taoyan date:2022-5-24 for:VUEN-1088 online 导入 省市区导入后
                    ...
                    // update-end-author:taoyan date:2022-5-24 for:VUEN-1088 online 导入 省市区导入后 导入数据错乱
                    // 北京市/市辖区/西城区-->山西省/晋城市/城区
                }
            }
        }
        return null;
